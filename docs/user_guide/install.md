...
- [**nvector**](https://nvector.readthedocs.io/en/latest/) is used `huracanpy.calc.corral_radius` to find the centre of a group of points while accounting for a spherical Earth
